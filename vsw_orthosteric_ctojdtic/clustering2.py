...
cluster_labels = fcluster(linked, t=nclusters, criterion='maxclust')
cluster_labels1 = cluster_labels - 1
sil_score = silhouette_score(hmap1, labels=cluster_labels1, metric='precomputed')
print(f'Silhouette Score for {args.cutoff} is {sil_score}')
