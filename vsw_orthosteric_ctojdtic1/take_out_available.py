#########How to use?
######### $SCHRODINGER/run ./take_out_available.py for_extract_available_molecules.maegz 
...
def get_ligs_info(filename):
      ...
      with structure.StructureReader(filename) as reader:  
           for i, st in enumerate(reader):
               ...
               if st.property['i_user_available']==1:
...
if __name__ == "__main__":
      ...
      print("Number of available molecules")
      print(len(index_available))
      print("Number of unavailable molecules")
      print(len(index_not_available))
      extract_poses(index_available, filename, "fp0.75_cluster_lowestE_charged_int_1_with_polar_int_available.mae")
      #extract_poses(index_charged_int_0, filename, "fp0.75_cluster_lowestE_charged_int_0_with_polar_int_not_available.mae")
